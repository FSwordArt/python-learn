...
class FPOINT(object):
    def __init__(self):
        self.lon = []
        self.lat = []
# class info_m_nStormBoundaryPoint(Titan_Storm):
#     def __init__(self, m_nStormCount, m_nStormBoundaryPointNum):
...
# def save_titan(year,month,day,hour,minute,num,nforecastminute,nstormboundarypointnum):
    ...
    m_datetime.m_nYear = path[0][]
    m_datetime.m_nMonth = path[0][]
    save_lon = []
    save_lat = []
    save_lonlat = []
